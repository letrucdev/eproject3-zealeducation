...
@Component({
  selector: 'app-session-attendance-page',
  imports: [
    DatePipe,
    RouterLink,
    HlmBadgeImports,
  ...
  templateUrl: 'session-attendance-page.html',
})
export default class SessionAttendancePage {
  ...
  protected readonly backLink = computed(() => {
    ...
    return id ? `/app/incharge/batches/${id}` : '/app/incharge/batches';
  });
