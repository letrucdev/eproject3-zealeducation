...
public class GetFacultyBatchesQueryHandler(
    IRepository<Batch> batchRepository,
    IRepository<FacultyEntity> facultyRepository,
    ICurrentUser currentUser) : IRequestHandler<GetFacultyBatchesQuery, PaginatedList<BatchListItemDto>>
{
    public async Task<PaginatedList<BatchListItemDto>> Handle(GetFacultyBatchesQuery request, CancellationToken cancellationToken)
    {
        ...
        var query = batchRepository.Query().Where(b => b.FacultyId == facultyId);
