...
public class CreateStaffCommandValidatorTests
{
    ...
    private static CreateStaffCommand Valid(
    ...
    [Fact]
    public void Should_fail_when_username_is_shorter_than_3_chars()
    {
    ...
    [Fact]
    public void Should_fail_when_password_is_shorter_than_8_chars()
    {
    ...
    {
        var result = _validator.TestValidate(Valid(password: new string('a', 101)));
        result.ShouldHaveValidationErrorFor(c => c.Password);
    }
